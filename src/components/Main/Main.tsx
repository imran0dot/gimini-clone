    ...
    return (
        <div className="relative border min-h-screen flex flex-col justify-between">
            ...
            <ScrollArea className="h-[80vh]">
                <div className="w-10/12 mx-auto flex flex-col justify-center h-full min-h-screen">
                    <Banner />

                    {/* generated text */}
                    <div className="mt-10 flex flex-col gap-10" ref={generatedBox}></div>
                </div>
            </ScrollArea>
            ...
            <div className="w-10/12 mx-auto pb-5">
                ...
                >
                    <input
                        className="bg-transparent w-10/12 py-5 focus:border-e-red-500"
